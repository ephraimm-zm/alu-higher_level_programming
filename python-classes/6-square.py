...
class Square:
    ...
    position: Getter method for retieving the position of the square.
    ...
    def position(self):
        """
        Getter method for retieving the position of the square.
    ...
    def my_print(self):
        """
        Prints the square using the '#' char, considering the position
        """
        if self.size == 0:
            print()
            return
